...
import { useFocusTrap } from "@/civic-ui/lib/use-focus-trap";
...
.animate-backdrop-in{animation:backdrop-in 200ms ease both}
@media (prefers-reduced-motion:reduce){.animate-backdrop-in{animation:none}}
`}</style>
