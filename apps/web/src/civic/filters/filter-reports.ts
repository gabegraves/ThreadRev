...
import { PRESET_DAYS, type ReportFilter } from "@/civic/filters/types";
import { DAY_MS } from "@/civic/lib/time-constants";
...
export function filterReports(
  ...
  return reports.filter((r) => {
    if (filter.team !== "all" && (r.assigned_team ?? "all") !== filter.team) {
      return false;
    }
