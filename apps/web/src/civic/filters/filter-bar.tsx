...
import BottomSheet from "@/civic/filters/bottom-sheet";
import { CATEGORY_META, categoryMeta } from "@/civic/lib/dashboard-data";
import { useFilters } from "@/civic/filters/context";
import {
  type DateRangePreset,
  DEFAULT_FILTER,
  PRESET_LABELS,
} from "@/civic/filters/types";
import { TEAM_LIST, TEAMS, type TeamId } from "@/civic/lib/teams";
        ...
        <div className="flex flex-wrap items-center gap-x-2.5 gap-y-2">
          ...
          {lockedTeam ? (
            <span
              ...
              title="This view is scoped to one channel"
            >
          ...
          <Popover
            trigger={(open) => (
              <TriggerPill
                ...
                label={sevActive ? `Sev ${filter.minSeverity}+` : "Failing checks"}
                active={sevActive}
                open={open}
              />
            )}
