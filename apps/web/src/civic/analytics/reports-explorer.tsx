...
import { ReportDetail } from "@/civic/analytics/report-detail";
import { Drawer } from "@/civic/analytics/drawer";
    ...
    <>
      <div className="fixed inset-0 z-50 animate-in fade-in duration-200">
        <button
          type="button"
          onClick={onClose}
          aria-label="Close findings explorer"
          className="absolute inset-0 bg-black/75 backdrop-blur-md"
        />
        <div
          role="dialog"
          aria-modal="true"
          aria-label="Findings explorer"
          className={cn(
      ...
      <Drawer
        ...
        title={
          selectedReport
            ? (CATEGORY_META[selectedReport.category]?.label ?? "Finding")
            : "Finding"
        }
        side="right"
      >
