...
/* ==================================================================
   ...
   Extracted from Civic analytics/bento-primitives.tsx. The opt-in
   `tilt` prop is dropped here — it pulled in the app-local
   useTiltHover/hover-tip module and was off by default.
