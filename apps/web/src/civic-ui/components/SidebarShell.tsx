...
export interface SidebarNavItem {
  ...
  sub?: SidebarSubItem[];
  /** Optional trailing count, mono and quiet. Hidden while collapsed. */
  count?: number;
}

const STORAGE_KEY = "threadrev.sidebar-collapsed";
...
export function SidebarNav({
  ...
  return (
    <nav aria-label={heading} className="flex flex-col gap-0.5">
      ...
      {items.map(({ label, href, icon: Icon, active, sub, count }) => {
