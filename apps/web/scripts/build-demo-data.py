 ...
 * Verbatim copy of fixtures/workspace/kestrel-workspace.json: the Slack export
 * the reviewer's exact-match workspace index is built from (F12/F14).
 */
import type { WorkspaceMessage } from "../workspace-index";

export const WORKSPACE: WorkspaceMessage[] = %s;
"""
