...
- Fictional data only. The company is Kestrel Motors, a fictional electric vehicle maker. If a name, number, supplier, or part is not in the spec, invent one that is obviously fictional.
