...
Lane handoffs: [research/handoff-frontend-demo.md](research/handoff-frontend-demo.md) (state of the project, demo story, video plan), [research/handoff-demo-narrative.md](research/handoff-demo-narrative.md), [research/handoff-slack-environment.md](research/handoff-slack-environment.md), [research/handoff-openai-key.md](research/handoff-openai-key.md). Eval lane: [research/handoff-eval-lane.md](research/handoff-eval-lane.md) for the human, [research/agent-briefs/w5-eval-mechanics.md](research/agent-briefs/w5-eval-mechanics.md) for their agent, [research/handoff-red-team.md](research/handoff-red-team.md) for the case patterns.
