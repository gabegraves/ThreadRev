...
Start with [SETUP.md](SETUP.md). The research and proposed design live in [RESEARCH.md](RESEARCH.md) and [research/hackathon-design.md](research/hackathon-design.md). Preserve them. Use the Slack template first; web is an optional local preview, not another required product surface.
